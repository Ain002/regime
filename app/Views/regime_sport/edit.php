...
<div class="container mt-5">
    ...
    <form action="<?= site_url('admin/regime-sport/update/' . $regime['id'] . '/' . $regimeSport['sport_id']) ?>" method="POST" class="form mt-4">
        <?= csrf_field() ?>
        ...
        <div class="d-flex gap-2 mt-4">
            ...
            <a href="<?= site_url('admin/regime-sport/' . $regime['id']) ?>" class="btn btn-secondary">❌ Annuler</a>
        </div>
    </form>
</div>
<?php $this->endSection() ?>
