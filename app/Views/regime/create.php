...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form method="post" action="<?= site_url('admin/regime/store') ?>">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <input type="number" name="duree" class="form-control" min="1" value="<?= old('duree') ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Prix (Ar)</label>
                <input type="number" step="0.01" min="0" name="prix" class="form-control" value="<?= old('prix') ?>" required>
            </div>
            <div class="form-group">
            ...
            <?php foreach ($aliments as $aliment): ?>
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" min="0" max="100" class="form-control" name="percentage[<?= $aliment['id'] ?>]" value="<?= old('percentage.' . $aliment['id'], 0) ?>">
                </div>
            <?php endforeach; ?>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">Créer régime</button>
